...
ScrollReveal().reveal('#kuma', { delay: 100, origin: 'left' })
ScrollReveal().reveal('#kuma1', { delay: 100, origin: 'right' })
ScrollReveal().reveal('#kuma2', { delay: 100, origin: 'left' })
ScrollReveal().reveal('#kuma3', { delay: 100, origin: 'right' })

ScrollReveal().reveal('.zimbei', { delay: 100, origin: 'right' })